...
subtitle:  '`<img src="img/barper.svg">`<br>Sesion 001'
author: 'Antony Barja'
...
<br>
`Es una herramienta integradora que permite manipular, getionar y trabajar información georreferenciada.`
...
# Por qué usar QGIS?
.pull-top[
```{r,echo=FALSE,out.width="550px",out.height="200px",fig.align='center'}
...
```{r, echo=FALSE,out.width="600px",out.height="400"}
...
```{r, echo=FALSE,out.width="700px",out.height="250",fig.align='right'}
...
##### _Insumos_ [Aquí 🐇👇](https://github.com/barjageo/CursoQGIS3.X/tree/master/Sesion001/Insumos)
---
background-size: cover
class: center, middle, inverse
