...
Geographycal Data Mining hace referencia al inmenso volumen de datos georreferenciados que se van generando de manera continua, y que hoy en día en su mayoria estan disponibles en fuentes abiertas dentro de mundo online de internet.
...
```{r, echo=FALSE,fig.align='center'}
knitr::include_graphics("img/part1.png")
```
---
# Ejercicio 002

```{r, echo=FALSE,fig.align='center'}
knitr::include_graphics("img/parte2.png")
```
---
# Ejercicio 003
```{r, echo=FALSE,fig.align='center'}
knitr::include_graphics("img/parte3.png")
```
---
background-size: cover
class: center, middle, inverse
...
---
# La estadística espacial se divide en 3 grandes áreas:
